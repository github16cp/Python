...
安装好Chrome浏览器后，打开Chrome，在菜单中选择“视图”，“开发者”，“开发者工具”，就可以显示开发者工具,或者直接按F12即可以进入开发者模式：
...
`HTTP`响应分为Header和Body两部分（Body是可选项），我们在`Network`中看到的Header最重要的几行如下：
```Python
200 OK
```
...
要详细了解HTTP协议，推荐“[HTTP: The Definitive Guide](http://shop.oreilly.com/product/9781565925090.do)”一书，非常不错，有中文译本：[HTTP权威指南](https://www.amazon.cn/dp/B008XFDQ14/ref=cm_sw_r_si_7_dp_T.Qzub1780N06)
## 19.2 HTML简介
...
* [Tornado](http://www.tornadoweb.org/en/stable/)：Facebook的开源异步Web框架。
...
* [Cheetah](http://cheetahtemplate.org/)：也是用<% ... %>和${xxx}的一个模板；
